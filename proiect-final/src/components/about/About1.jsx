...
function About1(props) {
  ...
  const [dataBlock] = useState({
    heading: "About Me",
    desc: "Hello everyone and welcome to my Official Website. My name is Alessandro Danescu and I am a young artist, singer and songwriter, full of ambitious goals and a lot of good energy.",
  });
