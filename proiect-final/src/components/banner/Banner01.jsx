                    ...
                    <div className="tf-slider-item">
                      <div className="content-inner">
                        ...
                        <div className="btn-slider ">
                          <Button path="#" title="SIGN UP" />
                          <Button02 path="/collection" title="COLLECTION" />
                        </div>
                      </div>
                      ...
                      <div className="content-right ">
                        <div className="content-slide">
                          <div className="image">
                            <img src={img1} alt="" className="img-slider-1" />
                            <img src={img4} alt="" className="fadeInClass" />
                          </div>
                          <div className="image s1">
                            <img src={img2} alt="" className="img-slider-1" />
                            <img src={img5} alt="" className="fadeInClass" />
                          </div>
                          <div className="image s1">
                            <img src={img3} alt="" className="img-slider-1" />
                            <img src={img6} alt="" className="fadeInClass" />
                          </div>
                        </div>
                      </div>
                    </div>
