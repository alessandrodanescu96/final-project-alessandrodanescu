...
import "./styles.scss";
import logo from "../../assets/images/logo/logo.png"; //188x42 pixeli
import logodark from "../../assets/images/logo/logo_dark.png"; //188x42 pixeli
          ...
          <div className="col-md-12">
            <div id="site-header-inner">
              ...
              <div className="header-right">
                ...
                <Link to="/contact" className="tf-button discord">
